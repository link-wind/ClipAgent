...
class AgentService:
    ...
    def _set_grounding(self, session: AgentSession, grounding: Any) -> None:
        session.status = AgentStatus.PLAN_READY
        session.plan = None
    ...
    def _build_grounded_plan_from_candidates(self, prompt: str, grounding: Any, candidate_ids: list[str]) -> EditPlan:
